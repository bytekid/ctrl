DIR   := src/tool
PACK  := Tool
DEP   := Util Parsec Ctrs Smt Rewriting Io Confluence Termination Inductive
GENERATED :=
FILES := \
  main.ml
  $(GENERATED)
# packs to include in executable, in dependency order
PACKS_$(PACK) := Util Parsec Ctrs Smt Rewriting Io Confluence Termination Inductive Tool
